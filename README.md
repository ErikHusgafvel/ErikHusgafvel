...
6) [Typescript Full stack Patientor-app](https://github.com/ErikHusgafvel/HY-MOOC-Full-stack-development/tree/master/osa9/patientor). Front- and backend solutions for creating and showing patient information.
   ...
   - Back-end solution utilizes node.js runtime environment and express-service. Database solution utilized is a document-oriented MongoDB. Key-words: typescript, ts-node, express, mongodb, mongoose, jsonwebtoken, bcrypt, nodemon, eslint, jest, supertest
